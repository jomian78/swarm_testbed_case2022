...
class Object(object):
    __slots__ = ['l','w','dim','_p','_t_mat','_quat'] # pre-allocate for RAM efficiency
...
class Map(Visual):
    __slots__ = ['objects','_rate'] # pre-allocate for RAM efficiency
    ...
    def run(self):
        while not rospy.is_shutdown():
            self.update_rendering() # TODO: is this even necessary? [yes]
            self._rate.sleep()
